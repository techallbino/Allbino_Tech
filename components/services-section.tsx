  ...
  return (
    <Reveal delay={index * 80}>
      <a
        ...
        className="group flex h-full flex-col rounded-2xl border border-border bg-card p-4 transition-all duration-300 hover:-translate-y-1 hover:border-primary/60 hover:shadow-[0_0_30px_-10px_var(--color-primary)] sm:p-6"
      >
        <div className="flex items-center justify-between">
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-secondary text-primary transition-colors group-hover:bg-primary group-hover:text-primary-foreground sm:h-11 sm:w-11">
        ...
        <h4 className="mt-4 text-base font-semibold sm:mt-5 sm:text-lg">{service.title}</h4>
        <p className="mt-1.5 text-[13px] leading-5 text-muted-foreground sm:mt-2 sm:text-sm sm:leading-relaxed">{service.description}</p>
        <span className="mt-3 text-[11px] font-medium text-primary opacity-100 transition-opacity sm:mt-4 sm:text-xs sm:opacity-0 sm:group-hover:opacity-100">
...
export function ServicesSection() {
  return (
    <section id="servicos" className="scroll-mt-20 py-14 md:py-28">
      <div className="mx-auto max-w-6xl px-4">
        <Reveal className="mx-auto max-w-2xl text-center">
          <h2 className="text-balance text-3xl font-bold tracking-tight md:text-4xl">
            Nossos serviços
          </h2>
          <p className="mt-3 text-pretty text-sm leading-6 text-muted-foreground sm:mt-4 sm:text-base sm:leading-relaxed">
        ...
        <div className="mt-10 grid items-center gap-6 sm:mt-16 sm:gap-10 lg:grid-cols-2">
          <Reveal className="order-2 lg:order-1">
            <div className="relative">
              <div className="absolute inset-0 -z-10 rounded-3xl bg-primary/10 blur-2xl" />
              <Image
                src="/images/hardware-software.webp"
                alt="Técnico realizando manutenção em hardware de computador"
                width={620}
                height={460}
                sizes="(max-width: 1024px) 100vw, 50vw"
                className="h-[250px] w-full rounded-2xl border border-border object-cover sm:h-[380px] sm:rounded-3xl lg:h-auto"
              />
            </div>
          </Reveal>
          <div className="order-1 lg:order-2">
            <Reveal>
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground sm:mt-3 sm:text-base sm:leading-relaxed">
        ...
        <div className="mt-14 grid items-center gap-6 sm:mt-20 sm:gap-10 lg:grid-cols-2">
          <div>
            <Reveal>
              <span className="text-xs font-medium uppercase tracking-wider text-primary sm:text-sm">
                Novidade
